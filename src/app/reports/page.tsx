      ...
      <div className="max-w-6xl mx-auto px-4 py-16 md:py-24">
        ...
        <header className="mb-16 relative">
          ...
          <p className="text-lg text-gray-400 max-w-2xl">
            Browse our library of AI-generated financial intelligence reports. Each report is automatically analyzed, structured, and verified against the original source document.
          </p>
        </header>
        ...
        {publishedDocs.length === 0 ? (
          <div className="text-center py-20 border border-white/5 rounded-3xl bg-white/[0.02]">
            ...
            <h3 className="text-xl font-medium text-gray-300">No reports published yet</h3>
            <p className="text-gray-500 mt-2">Check back later for new insights.</p>
          </div>
        ) : (
