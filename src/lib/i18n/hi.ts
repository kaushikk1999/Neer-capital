...
export const hi: TranslationDict = {
  ...
  'solutions.sol1.title': 'निवेश, जोखिम एवं अनुपालन',
  'solutions.sol1.body': 'परिश्रम में तेज़ी लाएँ और विषयगत शोध को निवेश कथाओं में संश्लेषित करें, जबकि हर प्रतिक्रिया को अनुमतियों, समीक्षा लॉग और सुरक्षा नियंत्रणों के माध्यम से स्वीकृत स्रोतों तक ट्रेस किया जाता है।',
  ...
  'feedback.generalHeading': 'Neer को बेहतर बनाने में मदद करें',
  'feedback.generalBody': 'Neer जटिल शोध रिपोर्ट को संरचित, स्रोत-आधारित अंतर्दृष्टि में बदलता है। हमें बताएं कि वे आपके लिए कितनी उपयोगी हैं और क्या उन्हें आपके काम में अधिक मूल्यवान बना सकता है।',
  ...
  'feedback.time': 'लगभग 2 मिनट लगते हैं',
  ...
  'verify.verifying': 'आपका ईमेल सत्यापित हो रहा है…',
  'verify.success': 'आपका ईमेल सत्यापित हो गया है। अब आप साइन इन कर सकते हैं।',
  'verify.invalid': 'यह सत्यापन लिंक अमान्य है या समाप्त हो चुका है।',
  'verify.resendLink': 'ईमेल सत्यापित करना है? लिंक फिर से भेजें',
  'verify.resendBody': 'अपना ईमेल दर्ज करें और यदि खाते को अभी भी आवश्यकता है तो हम सत्यापन लिंक फिर से भेजेंगे।',
  'verify.resendBtn': 'सत्यापन ईमेल फिर से भेजें',
  'verify.resendSending': 'भेजा जा रहा है…',
  ...
  // ── Report page ──
  'report.viewPdf': 'मूल PDF देखें',
  'report.executiveSummary': 'कार्यकारी सारांश',
  'report.noSummary': 'कोई कार्यकारी सारांश उपलब्ध नहीं।',
  'report.keyMetrics': 'मुख्य मैट्रिक्स',
  'report.visualizations': 'विज़ुअलाइज़ेशन',
  ...
  'chart.legendHint': 'ठोस = रिपोर्ट किया गया · धराशायी = पूर्वानुमान',
  'chart.periodsIdentified': 'पहचानी गई अवधियाँ:',
  'chart.class.A': 'वास्तविक',
  'chart.class.R': 'पुनर्कथित',
  'chart.class.P': 'प्रारंभिक',
  'chart.class.G': 'प्रबंधन मार्गदर्शन',
  'chart.class.E': 'विश्लेषक अनुमान',
  'chart.class.C': 'सर्वसम्मत अनुमान',
  'chart.class.S': 'परिदृश्य',
  'chart.class.AI': 'प्लेटफ़ॉर्म व्युत्पन्न',
  'chart.conf.HIGH': 'उच्च',
  'chart.conf.MEDIUM': 'मध्यम',
  'chart.conf.LOW': 'निम्न',
  'chart.conf.CONFLICTING': 'विरोधाभासी',
  'chart.noData': 'इस चार्ट के लिए कोई स्रोत डेटा उपलब्ध नहीं है।',
  'chart.noValues': 'स्रोत रिपोर्ट में इस मीट्रिक के लिए कोई मान नहीं मिला।',
  'chart.notDisclosed': '{n} अवधि प्रकट नहीं की गई (अंतराल के रूप में दिखाया गया)',

  // ── Transactional emails ──
  'email.reset.subject': 'अपना Neer Capital पासवर्ड रीसेट करें',
  'email.reset.p1': 'हमें आपका पासवर्ड रीसेट करने का अनुरोध मिला।',
  'email.reset.link': 'रीसेट करने के लिए यहाँ क्लिक करें',
  'email.reset.validity': '(1 घंटे के लिए मान्य)',
  'email.reset.ignore': 'यदि आपने यह अनुरोध नहीं किया है, तो आप इस ईमेल को अनदेखा कर सकते हैं।',
  'email.verify.subject': 'अपना Neer Capital ईमेल सत्यापित करें',
  'email.verify.p1': 'अपना Neer Capital खाता सेट करना पूरा करने के लिए अपना ईमेल पुष्टि करें।',
  'email.verify.link': 'मेरा ईमेल सत्यापित करें',
  'email.verify.validity': '(1 घंटे के लिए मान्य)',
  'email.verify.ignore': 'यदि आपने यह खाता नहीं बनाया है, तो इसे सत्यापित न करें — आप इस ईमेल को सुरक्षित रूप से अनदेखा कर सकते हैं, और यदि पता आपका है तो आप साइन-इन पेज से पासवर्ड रीसेट कर सकते हैं।',
};
