...
export const hi: TranslationDict = {
  ...
  'feedback.generalHeading': 'Neer अब तक कितना उपयोगी है?',
  'feedback.generalBody': 'हम शुरुआती उपयोगकर्ताओं के साथ Neer का परीक्षण कर रहे हैं। बताएं कि क्या अच्छा है, क्या भ्रमित करने वाला है, और आप शोध रिपोर्ट से क्या चाहते हैं।',
