...
export const pricingPlans: PricingPlan[] = [
  { name: 'Self-serve', price: 'Starting at custom', description: 'For lean teams that want to move quickly with a secure, ready-to-use platform.', features: ['Core AI workflows', 'Source citations', 'Team collaboration', 'Standard support'], cta: { label: 'Start conversation', href: '/contact' } },
...
export const faqs: FAQItem[] = [
  ...
  { q: 'Can we support multilingual research workflows?', a: 'Yes. The platform supports multilingual workflows and can translate, normalize, and compare materials across regions.' },
